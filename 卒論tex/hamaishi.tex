...
戦闘における行動は,表\ref{tableBattleAction}(\pageref{tableBattleAction}ページ)に示すもののうち1つを選んで行う。
\begin{table}[hpbt]
\caption{戦闘における行動}
...
\begin{figure}[hpbt]
\begin{center}
\includegraphics[scale=0.25]{afc4z-cp0dg.eps}
\end{center}
...
当研究ではディレクターの調整した難易度を測るために,自動でゲームを複数回プレイした際それらのプレイでどこまで進めることができたか(以降,最終到達階層と記す)の平均を求め,これを難易度の指標としている。
\begin{figure}[hpbt]
\begin{center}
...
\bibitem{}
バイオハザード4 解体真書, スタジオベントスタッフ, 2005年4月2日
\bibitem{}
